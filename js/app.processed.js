...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _textdata = __webpack_require__(327);

	var _textdata2 = _interopRequireDefault(_textdata);

	var _chaptercomponents = __webpack_require__(328);

	var _chaptercomponents2 = _interopRequireDefault(_chaptercomponents);
	...
	var _Reactstrap = Reactstrap,
	    ...
	    Card = _Reactstrap.Card,
	    CardImg = _Reactstrap.CardImg,
	    CardBody = _Reactstrap.CardBody,
	    CardText = _Reactstrap.CardText,
	    CardTitle = _Reactstrap.CardTitle,
	    CardSubtitle = _Reactstrap.CardSubtitle,
	    Col = _Reactstrap.Col,
	    Container = _Reactstrap.Container,
	    Dropdown = _Reactstrap.Dropdown,
	    DropdownItem = _Reactstrap.DropdownItem,
	    DropdownMenu = _Reactstrap.DropdownMenu,
	    DropdownToggle = _Reactstrap.DropdownToggle,
	    Row = _Reactstrap.Row,
	    Input = _Reactstrap.Input,
	    Tooltip = _Reactstrap.Tooltip,
	...
	var NavDescription = function (_React$Component) {
	  ...
	  function NavDescription(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, (NavDescription.__proto__ || Object.getPrototypeOf(NavDescription)).call(this, props));
	  ...
	  _createClass(NavDescription, [{
	    ...
	    key: 'changeChapter',
	    value: function changeChapter(name) {
	...
	var MyNavBar = function (_React$Component2) {
	  _inherits(MyNavBar, _React$Component2);
	  ...
	  _createClass(MyNavBar, [{
	    key: 'changeChapter',
	    value: function changeChapter(num) {
	      this.props.cb(num);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          Nav,
	          { id: 'chapters' },
	          _textdata2.default.chapters.map(function (chapter, index) {
	            return React.createElement(
	              NavItem,
	              null,
	              React.createElement(
	...
	var ChapterWrapper = function (_React$Component3) {
	  _inherits(ChapterWrapper, _React$Component3);

	  function ChapterWrapper() {
	    _classCallCheck(this, ChapterWrapper);

	    return _possibleConstructorReturn(this, (ChapterWrapper.__proto__ || Object.getPrototypeOf(ChapterWrapper)).apply(this, arguments));
	  }

	  _createClass(ChapterWrapper, [{
	    key: 'render',
	    value: function render() {
	      return React.createElement(
	        'div',
	...
	var Application = function (_React$Component4) {
	  ...
	  _createClass(Application, [{
	    key: 'changeChapter',
	    value: function changeChapter(chapter) {
	      this.setState({
	        chapter: chapter
	      });
	    }
	    ...
	    value: function render() {
	      ...
	      switch (this.state.chapter) {
	        case 'Credits':
	          main = React.createElement(_chaptercomponents2.default.Credits, null);
	          break;
	        case 'Sandbox':
	          main = React.createElement(_chaptercomponents2.default.Sandbox, null);
	          break;
	        default:
...
/***/ (function(module, exports) {
	...
	var code_credit = ['NavBar By Jennie Zheng', 'blandit diam vel, mattis arcu', 'Morbi auctor leo congue', 'Aliquam vel risus at libero'];
	var lesson_credit = ['Dropout Page by No Name', 'blandit diam vel, mattis arcu', 'Morbi auctor leo congue', 'Aliquam vel risus at libero'];
	var design_credit = ['Animal Pictures by No Name and No Name', 'blandit diam vel, mattis arcu', 'Morbi auctor leo congue', 'Aliquam vel risus at libero'];
	var credits = { code: code_credit, lesson: lesson_credit, design: design_credit };

	var Chapter = function Chapter(_ref) {
	  var _ref$name = _ref.name,
	      name = _ref$name === undefined ? 'no name' : _ref$name,
	      _ref$icon = _ref.icon,
	      icon = _ref$icon === undefined ? 'fa-circle-o' : _ref$icon,
	      _ref$desc = _ref.desc,
	...
	*/
	...
	var Project = function Project(_ref2) {
	  var _ref2$name = _ref2.name,
	      name = _ref2$name === undefined ? 'no name' : _ref2$name,
	      _ref2$desc = _ref2.desc,
	      desc = _ref2$desc === undefined ? 'no desc' : _ref2$desc,
	      _ref2$url = _ref2.url,
	      url = _ref2$url === undefined ? '#' : _ref2$url,
	      _ref2$author = _ref2.author,
	      author = _ref2$author === undefined ? 'no author' : _ref2$author,
	      _ref2$img = _ref2.img,
	      img = _ref2$img === undefined ? 'https://images.unsplash.com/photo-1472345113808-03a78a564cc5?dpr=1&auto=compress,format&fit=crop&w=1353&h=&q=80&cs=tinysrgb&crop=' : _ref2$img;
	...
	var Data = { chapters: chapters, projects: projects, credits: credits };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Sandbox = function (_React$Component) {
	  ...
	  function Sandbox() {
	    ...
	    return _possibleConstructorReturn(this, (Sandbox.__proto__ || Object.getPrototypeOf(Sandbox)).apply(this, arguments));
	  }
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(
	          Row,
	          null,
	          _textdata2.default.projects.map(function (project, index) {
	            return React.createElement(
	              Col,
	              { sm: "6" },
	              React.createElement(
	...
	var Credits = function (_React$Component2) {
	  _inherits(Credits, _React$Component2);
	  ...
	  _createClass(Credits, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        _textdata2.default.credits.code.map(function (line) {
	          return React.createElement(
	            "h3",
	            null,
	            line
	        ...
	        _textdata2.default.credits.lesson.map(function (line) {
	          return React.createElement(
	            "h3",
	            null,
	            line
	        ...
	        _textdata2.default.credits.design.map(function (line) {
	          return React.createElement(
	            "h3",
	            null,
	            line
	...
	var ChapterComponents = {
	  ...
	  Credits: Credits
		...
		exports.default = ChapterComponents;
